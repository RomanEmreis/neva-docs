...
* **[Release notes (v0.5.2)](https://github.com/RomanEmreis/neva/releases/tag/0.5.2)** and the [CHANGELOG](https://github.com/RomanEmreis/neva/blob/main/CHANGELOG.md) — the full migration narrative.
