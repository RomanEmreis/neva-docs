...
on the wire, no session `DELETE`, and no standalone SSE `GET` stream for
...
* **[Release notes (v0.5.0)](https://github.com/RomanEmreis/neva/releases/tag/0.5.0)** and the [CHANGELOG](https://github.com/RomanEmreis/neva/blob/main/CHANGELOG.md) — the full migration narrative.
