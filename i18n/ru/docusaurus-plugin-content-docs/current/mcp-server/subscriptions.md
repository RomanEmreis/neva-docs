...
Уведомления о прогрессе, статусе задач и elicitation **не** подписочные и
сохраняют поведение в области запроса: они идут по потоку ответа того запроса,
который их вызвал. См. [Журналирование → Доставка](./logging#delivery).
