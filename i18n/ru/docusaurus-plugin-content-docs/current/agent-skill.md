...
| `references/server.md` | Инструменты, промпты, ресурсы, схемы, имена аргументов, типы контента, DI, middleware, логи, подписки |
...
| `references/http.md` | Транспорты, TLS, JWT/OAuth, DNS-rebinding, свои движки, фича-флаги, развёртывание на нескольких экземплярах |
...
CI этого репозитория — больше шестидесяти штук, — поэтому то, что ассистент
...
Скилл описывает neva **0.5.2** / MCP **2026-07-28**, легаси-поколение
